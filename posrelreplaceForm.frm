VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} posrelreplaceForm 
   Caption         =   "pos(rel) Replace Form"
   ClientHeight    =   6630
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   7575
   OleObjectBlob   =   "posrelreplaceForm.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "posrelreplaceForm"
